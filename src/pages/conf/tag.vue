<template>
    <div>
        <div class="conftag-page-right">
            <bread-bar :bread-items="breadItems"></bread-bar>
            <div class="conftag-page-content">
...
<script>
    ...
    export default {
        ...
        methods: {
            getTagData(p) {
                const url = '/api/conftags' + '?page=' + p + '&page_size=' + 20
                Http.get(url)
                    .then((res) => {
            ...
            deleteSubmit() {
                const url = '/api/conftag/' + this.selectRow
                this.SubmitLoading = true
